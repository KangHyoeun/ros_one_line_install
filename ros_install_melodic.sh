...
#Checking version is bionic, if yes proceed othervice quit
case $version in
  "bionic" )
  ;;
  *)
...
echo ""
echo ">>> {Ubuntu bionic 18.04 is fully compatible with Ubuntu bionic 18.04}"
echo ""
echo "#######################################################################################################################"
...
#This will add the ROS melodic package list to sources.list 
